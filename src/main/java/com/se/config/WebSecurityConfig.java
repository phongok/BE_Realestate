	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().authorizeRequests()
				.antMatchers("/authen/register", "/authen/login", "/authen/hello", "/authen/signout", "/api/checkuser",
						"/api/users/{username}", "/api/users-paging", "/api/users-lock","/api/lockuser","/api/user/publicmoney","/api/unlockuser", "/api/user/create","/api/userscount",
						...
						"/api/reports-paging",
						"/api/stickreport", "/api/findReportByID", "/api/realestatesaves", "/api/realestatesaves/getlimit3", "/api/realestatesaves/forUser","/api/realestatesaves/{id}")
